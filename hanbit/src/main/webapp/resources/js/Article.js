		...
		var articleAllTable = 
			...
			for (var i = startPage; i <= endPage; i++) {
				if (i == pageNo) {
					...
					// '+context+'/article/list/'+i+'
					// onclick을 이용해 나 자신(함수)을 다시 호출한다.
					pagination += '<li><span><a class="otherPage" onclick="Article.prototype.articleAll('+'\''+context+'\''+','+'\''+i+'\')" href="#">'+i+'</span></a></li>';
				}
			}
